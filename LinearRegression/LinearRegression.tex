...
\begin{figure}
    \centering
    \includegraphics[width=0.5\paperwidth]{../LinearRegression/fig/diffregvalues.jpg}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\paperwidth]{../LinearRegression/fig/biasvariance.jpg}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\paperwidth]{../LinearRegression/fig/ridgereg.jpg}
    \caption{Form of the ridge regression function (left), effect on optimal weight selection (right).}
    \label{fig:ridge-reg-fn-form}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\paperwidth]{../LinearRegression/fig/lassoreg.jpg}
    \caption{Form of the lasso regression function (left), effect on optimal weight selection (right).}
    \label{fig:lasso-reg-fn-form}
\end{figure}
...
sequential estim? ridge regression as adding zero response data? Interpretation of regularization as a prior?

\subsection{Predictive Distribution}
Returning to the setting of Bayesian Linear Regression, what if we wished to get a distribution of $\textbf{w}$ instead of a point estimator for it using maximum likelihood? If we introduce a prior distribution over $\textbf{w}$, then together with our observed data, we can produce a posterior distribution over $\textbf{w}$ as we desire.
...
\end{align*}
Accounting for Normal-Normal conjugacy, our posterior distribution will be a Normal as well:
\begin{align*}
...
The idea here is to average the probability of $y^{*}$ over all the possible setting of \textbf{w}, weighting the probabilities by how likely each setting of \textbf{w} is according to its posterior distribution.
