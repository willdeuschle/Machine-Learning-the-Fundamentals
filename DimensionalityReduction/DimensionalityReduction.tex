...
TODO NEXT PICKUP HERE:

discuss the idea that all these eigenvectors span the entire D-dim space, they are orthogonal and thus the projections are completely uncorrelated and can be added to each other, how do we actually get these eigenvectors (SVD), how do we choose the number of eigenvectors we would like to actually keep.
